...
public abstract class AresWorldChunkManager extends WorldChunkManager
{
	...
	public abstract AresGenLayerZoom getGenLayer(long seed);

	private AresWorldChunkManager(long seed, WorldType worldType)
	{
		this();
		GenLayer[] agenlayer = getGenLayer(seed).construct(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public AresWorldChunkManager(World world)
	{
