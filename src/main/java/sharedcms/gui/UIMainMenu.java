...
public class UIMainMenu extends GuiScreen implements GuiYesNoCallback
{
	...
	public UIMainMenu()
	{
		GConfig.forceDefaults();
		this.field_146972_A = field_96138_a;
		this.splashText = "Press w";
	...
	protected void keyTyped(char c, int i)
	{
		if(c == 'w')
		{
			...
			WorldSettings worldsettings = new WorldSettings(i, gametype, true, false, Content.WorldType.ARES);
			worldsettings.func_82750_a("");
			worldsettings.enableCommands();
			this.mc.launchIntegratedServer(UUID.randomUUID() + "-" + ((Math.random() * 8) + ""), "Fast World", worldsettings);
		}
	}
	...
	protected void actionPerformed(GuiButton p_146284_1_)
	{
		if(p_146284_1_.id == 0)
		{
			this.mc.displayGuiScreen(new UIOptions());
		}

		if(p_146284_1_.id == 1)
		{
			this.mc.displayGuiScreen(new UISelectWorld(this));
		}
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
	{
		...
		float f1 = 1.8F - MathHelper.abs(MathHelper.sin((float) (Minecraft.getSystemTime() % 5000L) / 5000.0F * (float) Math.PI * 2.0F) * 0.1F);
		f1 = f1 * 200.0F / (float) (this.fontRendererObj.getStringWidth(this.splashText) + 32);
		GL11.glRotatef(-20, 0F, 0F, 1.0F);
		GL11.glScalef(f1, f1, f1);
		splashText = "Press W";
		double g = ((Math.sin((Minecraft.getSystemTime()) / 5000.0F)) + 1) / 2.0;
		int c = Color.getHSBColor((float) g, 1, 1).getRGB();
		this.drawCenteredString(this.fontRendererObj, this.splashText, 0, -8, c);
		GL11.glPopMatrix();
		String s = "Project Oberon";

		List<String> brandings = new GList<String>();
		brandings.add("Project Oberon");
		...
		String s1 = "Version " + Info.VERSION;
