package sharedcms.renderer.animation.weapon.spada;
...
public class SpadaAttack4
{
	public static void animate(EntityPlayer player, ModelBendsPlayer model, Data_Player data)
	{
		...
		bodyRot.x = 40.0f - armSwing * 20.0f;
		bodyRot.y = -10.0f * armSwing;
		...
		((ModelRendererBends) model.bipedRightArm).pre_rotation.setSmoothZ(-20.0f, 0.3f);
		((ModelRendererBends) model.bipedRightArm).rotation.setSmoothX(20.0f + armSwing * 100.0f, 5.0f);
		((ModelRendererBends) model.bipedRightArm).rotation.setSmoothX(44.0f + armSwing * 180.0f, 5.0f);
		((ModelRendererBends) model.bipedRightArm).rotation.setSmoothY(10.0f, 0.9f);
		((ModelRendererBends) model.bipedRightArm).rotation.setSmoothZ(-120.0f, 0.9f);
