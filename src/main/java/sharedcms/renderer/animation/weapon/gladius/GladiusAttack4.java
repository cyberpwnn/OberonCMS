...
public class GladiusAttack4
{
	public static void animate(EntityPlayer player, ModelBendsPlayer model, Data_Player data)
	{
		...
		((ModelRendererBends) model.bipedRightArm).rotation.setSmoothY(-20.0f, 0.9f);
		((ModelRendererBends) model.bipedLeftArm).rotation.setSmoothZ(-15.0f, 1.9f);
