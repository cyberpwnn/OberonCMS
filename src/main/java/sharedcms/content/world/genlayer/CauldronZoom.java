...
public class CauldronZoom extends Cauldron
{
	public CauldronZoom(long seed, GenLayer parent)
	{
		super(seed);
		super.parent = parent;
	}
	...
	public static Cauldron magnify(long seedAdjustment, Cauldron layer, int magnification)
	{
		Object object = layer;

		for(int k = 0; k < magnification; ++k)
		{
			object = new CauldronZoom(seedAdjustment + (long) k, (Cauldron) object);
		}
