...
public class WorldGenCustomTree extends WorldGenBigTree
{
	private boolean exc;
	private int tries = 1;
	...
	public WorldGenCustomTree(Block log, Block leaves, boolean update)
	{
		this(log, leaves, update, false, 1);
	}

	public WorldGenCustomTree(Block log, Block leaves, boolean update, boolean e, int t)
	{
		super(update);
