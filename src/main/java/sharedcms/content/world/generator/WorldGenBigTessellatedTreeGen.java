...
public class WorldGenBigTessellatedTreeGen extends WorldGenBigTree
{
	private boolean exc;
	private int tries = 1;
	...
	public int height;
	public double heightAttenuation = 4.618D;
	public double branchDensity = 1.0D;
	public double branchSlope = 0.381D;
	public double scaleWidth = 2D;
	public double leafDensity = 0.4D;
	private Block log;
	...
	public int heightLimitLimit = 24;
	/**
	 * Sets the distance limit for how far away the generator will populate leaves
	 * from the base leaf node.
	 */
	public int leafDistanceLimit = 7;
	/** Contains a list of a points at which to generate groups of leaves. */
	int[][] leafNodes;
	private static final String __OBFID = "CL_00000400";

	public WorldGenBigTessellatedTreeGen(Block log, Block leaves, boolean update)
	{
		this(log, leaves, update, false, 1);
	}

	public WorldGenBigTessellatedTreeGen(Block log, Block leaves, boolean update, boolean e, int t)
	{
		super(update);
	...
	public void func_150529_a(int p_150529_1_, int p_150529_2_, int p_150529_3_, float p_150529_4_, byte p_150529_5_)
	{
		...
		for(aint1[p_150529_5_] = aint[p_150529_5_]; i1 <= l; ++i1)
		{
			...
			while(j1 <= l)
			{
				...
				else
				{
					...
					{
						this.setBlockAndNotifyAdequately(this.worldObj, aint1[0], aint1[1], aint1[2], getLeavesBlock(), 0);
						++j1;
					}
				}
			}
	 ...
	 */
	public float layerSize(int p_76490_1_)
	{
	...
	public float leafSize(int p_76495_1_)
	{
	 ...
	 */
	public void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_)
	{
		int l = p_76491_2_;
		...
		for(int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l)
		{
			...
			this.func_150529_a(p_76491_1_, l, p_76491_3_, f, (byte) 1);
		}
	}
	...
	public void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block p_150530_3_)
	{
	 ...
	 * preserve integrity.
	 */
	public boolean leafNodeNeedsBase(int p_76493_1_)
	{
	...
	public int checkBlockLine(int[] p_76496_1_, int[] p_76496_2_)
	{
		int[] aint2 = new int[] { 0, 0, 0 };
		byte b0 = 0;
		byte b1;
	...
	public boolean validTreeLocation()
	{
		...
		boolean isSoil = isSoil(block) || block.canSustainPlant(worldObj, basePos[0], basePos[1] - 1, basePos[2], ForgeDirection.UP, (BlockSapling) Blocks.sapling);
		if(!isSoil)
		{
			return false;
		}
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
	{
		...
		for(int o = 0; o < tries; o++)
		{
			...
			{
				this.heightLimit = 4 + this.rand.nextInt(this.heightLimitLimit);
			}
