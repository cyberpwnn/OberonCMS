...
public class BiomeForestHillsExtreme extends AresBiome
{
	public BiomeForestHillsExtreme(int id)
	{
		super(id);
	}
	...
	{
		return super.getHeightVariation() + 0.2f;
	}
	...
	{
		return Content.BiomeDecorator.FOREST_HILLS_EXTREME;
	}

	@Override
	public WorldGenTrees getTreeGenerator()
	{
		return new WorldTessellatedTreeGen(Content.Block.LOG_DARK, Content.Block.LEAVES_DARK, false, 12, 0, 0, false);
	}
