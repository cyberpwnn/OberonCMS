...
public class BiomeDecoratorEmpty extends AresBiomeDecorator
{
	public BiomeDecoratorEmpty(AresBiome biome)
	{
		super(biome);
		...
		this.yellowFlowerGen = new WorldGenFlowers(Blocks.air);
