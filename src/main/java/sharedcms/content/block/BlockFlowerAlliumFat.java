...
public class BlockFlowerAlliumFat extends AresBlockOrientalShrub
{
	public BlockFlowerAlliumFat(String unlocalizedName, Material material, SoundType type, int weight)
	{
