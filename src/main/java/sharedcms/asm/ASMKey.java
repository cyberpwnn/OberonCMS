...
public class ASMKey
{
	...
	public static final String CKASS_BACKGROUNDBLURCONTROLLER = "sharedcms/controller/client/BackgroundBlurController";
	public static final String SIGNATURE_GUISCREEN_BACKGROUND_D = "getBackgroundColor";
	public static final String SIGNATURE_GUISCREEN_BACKGROUND_O = "(Z)I";
}
